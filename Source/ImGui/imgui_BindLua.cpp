...
void Game::ScriptBindings::ImGui::Bind(){
    ...
    LoadImguiBindings();
    wi::lua::RunText(Bindings_Globals);

    // Styling for ease
    ImVec4* colors = ::ImGui::GetStyle().Colors;
    colors[ImGuiCol_FrameBg]                = ImVec4(0.20f, 0.20f, 0.20f, 0.54f);
    colors[ImGuiCol_TitleBgActive]          = ImVec4(0.18f, 0.18f, 0.18f, 1.00f);
    colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4(0.03f, 0.36f, 0.66f, 1.00f);
    colors[ImGuiCol_Button]                 = ImVec4(0.52f, 0.52f, 0.52f, 0.40f);
    colors[ImGuiCol_Header]                 = ImVec4(0.32f, 0.32f, 0.32f, 0.31f);
...
void Game::ScriptBindings::ImGui::BeginFrame(){
    wi::lua::Signal("game_debug_ui");
}
